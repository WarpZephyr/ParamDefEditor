...
namespace CustomForms
{
    public partial class InputText : UserControl
    {
        ...
        [Category("Behavior")]
        [Description("The largest value the user can input into the InputBox up to the signed long limit.")]
        ...
        [Category("Behavior")]
        [Description("The smallest value the user can input into this InputBox up to the signed long limit.")]
